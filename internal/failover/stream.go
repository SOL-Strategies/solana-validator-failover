...
// and tower file sync
func (s *Stream) ConfirmFailover(failoverHooks hooks.FailoverHooks, activeRPCURL, passiveRPCURL string, skipPrompt bool) (err error) {
...
`)
	...
	// if skipPrompt is true, automatically proceed without asking for confirmation
	if skipPrompt {
		return nil
	}
